...
class GeneratedSiteTest(unittest.TestCase):
    ...
    def test_header_support_control_is_generated_on_every_page(self):
        ...
        for page in pages:
            ...
            self.assertIn("buy-me-a-coffee-logo.png?v=20260719-3", generated, page)
            ...
            self.assertRegex(generated, r'aria-label=["\']?Open menu["\']?', page)
            self.assertIn('class=nav-toggle-icon', generated, page)
            self.assertEqual(generated.count('class=nav-toggle-line'), 3, page)
